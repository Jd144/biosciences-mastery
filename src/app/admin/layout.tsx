...
import { ShieldCheck, BookOpen, List, FileText, HelpCircle, ClipboardList, Users, Tag, ShoppingCart, BarChart2, Settings, GraduationCap, FlaskConical } from 'lucide-react'
...
export default async function AdminLayout({
  ...
  const navItems = [
    ...
    { href: '/admin/exams', label: 'Biotech Exams', icon: FlaskConical },
