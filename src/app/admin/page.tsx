...
import { BookOpen, Users, ShoppingBag, FileText } from 'lucide-react'
...
export default async function AdminOverview() {
  ...
  const stats = [
    ...
    { label: 'Paid Orders', value: ordersRes.count ?? 0, icon: ShoppingBag, color: 'bg-purple-100 text-purple-600' },
